 ...
 **/
@Component
public class IpForbid2GatewayFilterFactory extends AbstractGatewayFilterFactory<IpForbid2GatewayFilterFactory.Config> {
     ...
     * @return
     **/
    public IpForbid2GatewayFilterFactory() {
        super(Config.class);
    }
